...
$registered_only = (bool) $form->get_meta( 'registered_only' );
$no_acceptance = (bool) $form->get_meta( 'no_acceptance' );
...
<table class="widefat" style="margin-top: 1em;">
<thead><tr><th scope="col"><?php echo esc_html( __( 'Options', 'suptic' ) ); ?></th></tr></thead>
<tbody>
<tr>
<td scope="col">
<div>
<input type="checkbox" id="registered-only" name="registered-only"<?php echo $registered_only ? 'checked="checked"' : ''; ?> />
<label for="registered-only"><?php echo esc_html( __( 'Users must be registered and logged in to open a ticket', 'suptic' ) ); ?></label>
</div>
<div>
<input type="checkbox" id="no-acceptance" name="no-acceptance"<?php echo $no_acceptance ? 'checked="checked"' : ''; ?> />
<label for="no-acceptance"><?php echo esc_html( __( 'Halt acceptance of new tickets', 'suptic' ) ); ?></label>
</div>
</td>
</tr>
</tbody>
