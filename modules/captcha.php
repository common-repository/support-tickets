...
add_filter( 'suptic_ajax_onload', 'suptic_captcha_ajax_refill' );
add_filter( 'suptic_ajax_json_echo', 'suptic_captcha_ajax_refill' );

function suptic_captcha_ajax_refill( $items ) {
	global $suptic_form;
